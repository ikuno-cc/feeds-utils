...
class ArchiveResponse(BaseModel):
    ...
    archive_url: str = Field(..., description="The resulting single archive shortlink URL")
    status: str = Field(..., description="Status of the archive operation (success, fallback, or cached)")
